...
from .models import User, Student, Teacher, Question, Answer, Lesson, Comment
...
class StudentSignUpForm(UserCreationForm):
    ...
    def save(self, commit=True):
        ...
        if commit:
            user.save()
        student = Student.objects.create(user=user, nom=self.cleaned_data.get('nom'), prenom=self.cleaned_data.get('prenom'), email=self.cleaned_data.get('email'), tel=self.cleaned_data.get('tel'), annEntre=self.cleaned_data.get('annEntre'))
        return user
