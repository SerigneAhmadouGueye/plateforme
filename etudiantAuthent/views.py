...
from .models import User, Question, Answer, Lesson, Comment, Etudiant, Professeur, Modul
from .forms import StudentSignUpForm, TeacherSignUpForm, LoginForm, QuestionForm, AnswerForm, LessonForm, CommentForm
